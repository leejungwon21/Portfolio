    ...
    <div style={{ paddingTop: "6rem", minHeight: "100vh" }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 800 }}>
          <p style={{ fontFamily: "DM Mono, monospace", fontSize: 11, letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--ink-faint)", marginBottom: "1rem" }}>01</p>
          <span style={{
          ...
          <p style={{ fontFamily: "DM Serif Display, serif", fontSize: "clamp(20px, 3vw, 32px)", color: "var(--ink-muted)", marginBottom: "1.5rem" }}>취업 준비생 통합 플랫폼</p>
          <p style={{ fontFamily: "DM Mono, monospace", fontSize: 12, color: "var(--ink-faint)", letterSpacing: "0.08em", marginBottom: "1.5rem" }}>2025</p>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
            {["서비스 기획", "UX Research", "Figma", "사용자 여정지도", "AI 구현", "피드백 개선"].map(t => (
              <span key={t} style={{
      ...
      <div style={{ borderBottom: "1px solid var(--line)" }}>
        <div style={{ padding: "3rem 3rem 1.5rem" }}>
          <p style={{
            ...
            letterSpacing: "0.15em", textTransform: "uppercase", color: accent, marginBottom: "1.25rem",
          }}>User Journey Map</p>
        </div>
        <div style={{ width: "100%", background: "var(--surface)", overflow: "hidden" }}>
          <Image
      ...
      <div style={{ padding: "4rem 3rem", maxWidth: 800 }}>
        {sections.map((s, i) => (
          <div key={i} style={{
            ...
            <p style={{
              fontFamily: "DM Mono, monospace", fontSize: 10,
              letterSpacing: "0.15em", textTransform: "uppercase", color: accent, paddingTop: 4,
            }}>{s.label}</p>
            <div>
              {"items" in s && s.items ? (
        ...
        {/* 관련 프로젝트 링크 */}
        <div style={{
          padding: "2rem", background: accentLight,
          borderRadius: 4, display: "flex", justifyContent: "space-between", alignItems: "center",
        }}>
          <div>
            <p style={{ fontFamily: "DM Mono, monospace", fontSize: 10, letterSpacing: "0.1em", textTransform: "uppercase", color: accent, marginBottom: 6 }}>관련 프로젝트</p>
            <p style={{ fontSize: 14, color: "var(--ink-muted)" }}>JOBMATE — 취업 준비의 모든 것</p>
          </div>
          <a href="https://jobmate-olive.vercel.app/" target="_blank" rel="noopener" style={{
            fontFamily: "DM Mono, monospace", fontSize: 11, letterSpacing: "0.1em",
            color: accent, textDecoration: "none", display: "flex", alignItems: "center", gap: 6,
            borderBottom: `1px solid ${accent}`, paddingBottom: 2, whiteSpace: "nowrap",
          }}>
            바로가기 ↗
          </a>
        </div>
