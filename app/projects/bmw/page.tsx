...
const images = [
  ...
  {
    src: "/images/bmw-03-analytics.png",
    caption: "KPI Analytics — 개별 지점 레이더 차트 & 인사이트",
  },
  {
    src: "/images/bmw-04-yoy.png",
    caption: "Year-over-Year — 연도별 KPI 비교 테이블",
  },
  {
    src: "/images/bmw-05-trend.png",
    caption: "Error Rate / TC Trend — 월별 트렌드 분석",
  },
];
...
const sections = [
  {
    label: "Overview",
    content:
      "다수 지점의 KPI를 매번 엑셀로 수작업 시각화하고 배포하는 과정이 반복적이고 비효율적이었습니다. Raw data 입력만으로 주요 지표를 자동 시각화하는 AI 기반 대시보드를 기획 및 제작했습니다.",
  },
  {
    label: "Problem",
    items: [
  ...
  },
  {
    ...
    content:
      "AI 도구는 사용법보다 '어떻게 요청하느냐'가 결과를 결정한다는 것을 배웠습니다. 프롬프트를 구조화하고 반복 개선하는 과정에서 AI 응답의 품질을 평가하고 기준을 세우는 경험을 했습니다. 업무 자동화는 기술이 아니라 문제 정의에서 시작한다는 것도 이 프로젝트에서 얻은 인사이트입니다.",
  },
];
